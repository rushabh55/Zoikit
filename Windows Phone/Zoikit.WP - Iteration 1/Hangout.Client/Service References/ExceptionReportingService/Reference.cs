...
// 
namespace Hangout.Client.ExceptionReportingService {
    ...
    public interface IExceptionReportingService {
        ...
        System.IAsyncResult BeginAddAnException(System.Guid userId, string appId, string apptoken, string message, string stackTrace, System.AsyncCallback callback, object asyncState);
        
        void EndAddAnException(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IExceptionReportingServiceChannel : Hangout.Client.ExceptionReportingService.IExceptionReportingService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ExceptionReportingServiceClient : System.ServiceModel.ClientBase<Hangout.Client.ExceptionReportingService.IExceptionReportingService>, Hangout.Client.ExceptionReportingService.IExceptionReportingService {
        ...
        System.IAsyncResult Hangout.Client.ExceptionReportingService.IExceptionReportingService.BeginAddAnException(System.Guid userId, string appId, string apptoken, string message, string stackTrace, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginAddAnException(userId, appId, apptoken, message, stackTrace, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void Hangout.Client.ExceptionReportingService.IExceptionReportingService.EndAddAnException(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginAddAnException(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Hangout.Client.ExceptionReportingService.IExceptionReportingService)(this)).BeginAddAnException(userId, appId, apptoken, message, stackTrace, callback, asyncState);
        }
        
        private object[] OnEndAddAnException(System.IAsyncResult result) {
            ((Hangout.Client.ExceptionReportingService.IExceptionReportingService)(this)).EndAddAnException(result);
            return null;
        }
        ...
        public void AddAnExceptionAsync(System.Guid userId, string appId, string apptoken, string message, string stackTrace) {
            this.AddAnExceptionAsync(userId, appId, apptoken, message, stackTrace, null);
        }
        
        public void AddAnExceptionAsync(System.Guid userId, string appId, string apptoken, string message, string stackTrace, object userState) {
        ...
        protected override Hangout.Client.ExceptionReportingService.IExceptionReportingService CreateChannel() {
            return new ExceptionReportingServiceClientChannel(this);
        }
        
        private class ExceptionReportingServiceClientChannel : ChannelBase<Hangout.Client.ExceptionReportingService.IExceptionReportingService>, Hangout.Client.ExceptionReportingService.IExceptionReportingService {
            
            public ExceptionReportingServiceClientChannel(System.ServiceModel.ClientBase<Hangout.Client.ExceptionReportingService.IExceptionReportingService> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginAddAnException(System.Guid userId, string appId, string apptoken, string message, string stackTrace, System.AsyncCallback callback, object asyncState) {
