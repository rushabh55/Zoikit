...
namespace Hangout.Client.Core.Authentication
{
    public class Accounts
    {
        ...
        internal static void DeleteTwitterData()
        {

            try
            {
                Settings.Settings.TwitterData = null;
            }
            catch (Exception ex)
            {
                Core.Exceptions.ExceptionReporting.Report(ex);
        ...
        {
            Settings.Settings.City = null;
            Settings.Settings.FacebookAccessToken = "";
            Settings.Settings.FacebookData = null;
            Settings.Settings.FacebookUserID = -1;
            Settings.Settings.FirstLaunch = true;
            Settings.Settings.LocationList = new System.Collections.ObjectModel.ObservableCollection<UserLocationService.City>();
            Settings.Settings.ProfileImageURL = "";
            Settings.Settings.PushNotificationSetting = null;
            Settings.Settings.TempPicImage = null;
            Settings.Settings.TwitterData = null;
            Settings.Settings.UnreadMesssages = 0;
            Settings.Settings.UnreadNotifications = 0;
            Settings.Settings.UserData = null;
            Settings.Settings.UserID = new Guid();
            Settings.Settings.ZAT = new Guid();
            Settings.Settings.LaunchCount = 0;
            Settings.Settings.Rated = false;
            Settings.Settings.EmailVerified = false;
            //clear cache
            WebBrowser web = new WebBrowser();
            web.ClearCookiesAsync();
            web.ClearInternetCacheAsync();

            Services.PushNotificationServiceClient.UnsubscribeAsync(Core.User.User.UserID, Core.User.User.ZAT);
        }
    }
}
