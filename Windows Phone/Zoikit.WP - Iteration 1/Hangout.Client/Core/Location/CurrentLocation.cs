...
namespace Hangout.Client.Core.Location
{
    public static class CurrentLocation
    {
        ...
        static void watcher_PositionChanged(object sender, GeoPositionChangedEventArgs<GeoCoordinate> e)
        {
            try
            {
                if (watcher.Status == GeoPositionStatus.Ready)
                {
                    ...
                    if (UpdateToServer)
                    {
                        Services.UserLocationServiceClient.UpdateUserLocationCompleted += UserLocationServiceClient_UpdateUserLocationCompleted;
                        Services.UserLocationServiceClient.UpdateUserLocationAsync(Core.User.User.UserID, Location.Latitude,Location.Longitude, Core.User.User.ZAT);
                    }
        ...
        static void UserLocationServiceClient_UpdateUserLocationCompleted(object sender, UserLocationService.UpdateUserLocationCompletedEventArgs e)
        {
            try
            {
                if (e.Error != null)
