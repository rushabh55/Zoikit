    ...
    public class PushNotification
    {
        ...
        private static void SubscribeToService()
        {
            try
            {
                ...
                Services.PushNotificationServiceClient.SubscribeAsync(Core.User.User.UserID, httpChannel.ChannelUri.ToString(), Core.User.User.ZAT.ToString());
            }
            catch (Exception ex)
            {
                Core.Exceptions.ExceptionReporting.Report(ex);
        ...
        private static void ParseMessageRealTimeNotification(XDocument document)
        {
            ...
            obj.TextId = new Guid((from c in document.Descendants("MessageRealTime")
            ...
            obj.User.UserID = new Guid((from c in document.Descendants("MessageRealTime")
        ...
        public static void UnBindToShellToast()
        {
            if (httpChannel != null)
            {
                if (httpChannel.IsShellToastBound)
