...
{
    public partial class BuzzHeaderPanel : UserControl
    {
        public BuzzHeaderPanel()
        {
            InitializeComponent();
        }
        ...
        public event EventHelper NavigateToComposeBuzz;

        public event EventHelper NavigateToLocationSelectorPage;

        private void Viewbox_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            if(NavigateToComposeBuzz!=null)
            {
