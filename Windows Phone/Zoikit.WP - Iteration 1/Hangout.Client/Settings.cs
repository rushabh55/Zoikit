...
namespace Hangout.Client.Settings
{
    public static class Settings
    {
        ...
        static string ToastEnabledKeyName = "ToastEnabledKey";
        static string LaunchCountKeyName = "LCKey";
        static string RatedKeyName = "RatedKeyName";
        static string EmailVerifiedKeyName = "EmailVerifiedKey";
        static  string PushNotificationsKeyName = "PushnotificationsKey";
        static string LocationsKeyName = "StaticLocationKey";
        ...
        static string UseLocationKey = "LOC";

        static int LaunchCountDefault = 0;

        static Guid UserIdDefault = new Guid();
        static UserLocationService.City CityDefault = null;
        static Guid? ZatDefault = null;
        static System.Collections.ObjectModel.ObservableCollection<UserLocationService.City> LocationListDefault = new System.Collections.ObjectModel.ObservableCollection<UserLocationService.City>();
        static  string UsernameDefault = "";
        static  long FacebookUserIdDefault = -1;
        static  string PushNotificationDefault = "";
        static bool RatedDefault = false;
        ...
        static bool EmailVerifiedDefault = false;
        ...
        static bool UseLocationDefault= true;
        static bool ToastEnabledDefault = true;
        /// <summary>
        ...
        public static System.Collections.ObjectModel.ObservableCollection<UserLocationService.City> LocationList
        {
            get
            {
                return GetValueOrDefault<System.Collections.ObjectModel.ObservableCollection<UserLocationService.City>>(LocationsKeyName, LocationListDefault);
            }
            set
            {
                AddOrUpdateValue(LocationsKeyName, value);
                Save();
            }
        }
        ...
        public static Guid UserID
        {
            get
            {
                return GetValueOrDefault<Guid>(UserIdKeyName, UserIdDefault);
            }
            set
            {
        ...
        public static bool EmailVerified
        {
            get
            {
                return GetValueOrDefault<bool>(EmailVerifiedKeyName, EmailVerifiedDefault);
            }
            set
            {
                AddOrUpdateValue(EmailVerifiedKeyName, value);
                Save();
            }
        }
        ...
        public static bool Rated
        {
            get
            {
                return GetValueOrDefault<bool>(RatedKeyName, RatedDefault);
            }
            set
            {
                AddOrUpdateValue(RatedKeyName, value);
                Save();
            }
        }
        ...
        public static bool ToastEnabled
        {
            get
            {
                return GetValueOrDefault<bool>(ToastEnabledKeyName, ToastEnabledDefault);
            }
            set
            {
                AddOrUpdateValue(ToastEnabledKeyName, value);
                Save();
            }
        }
        ...
        public static int LaunchCount
        {
            get
            {
                return GetValueOrDefault<int>(LaunchCountKeyName, LaunchCountDefault);
            }
            set
            {
                AddOrUpdateValue(LaunchCountKeyName, value);
                Save();
            }
        }
        ...
        public static bool UseLocation
        {
            get
            {
                return GetValueOrDefault<bool>(UseLocationKey, UseLocationDefault);
            }
            set
            {
                AddOrUpdateValue(UseLocationKey, value);
                Save();
            }
        }
        ...
        public static bool TempProfileClicked { get; set; }

        public static BitmapImage TempPicImage { get; set; }

        public static bool ProfilePicChanged { get; set; }
    }
}
